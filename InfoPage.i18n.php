...
'''[$3 гэтыя крокі]''' і зьвяртайцеся да [[{{MediaWiki:Wminc-manual-url}}|нашых інструкцыяў]].",
	...
	'wminc-infopage-option-multilingual' => 'Вы можаце перайсьці ў шматмоўную вікі:', # Fuzzy
...
$messages['lb'] = array(
	...
	'wminc-infopage-option-multilingual' => 'Dir kënnt op eng méisproocheg Wiki goen:', # Fuzzy
