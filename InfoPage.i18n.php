...
| meta = <!-- is there a request on Meta-Wiki? -->
	...
	'wminc-infopage-status-approved' => 'This Incubator wiki has been approved by the [[meta:Language committee|language committee]] and will be created soon.',
...
אתם יכולים [{{fullurl:{{FULLPAGENAME}}|action=edit}} ליצור דף] ולעקוב אחר [[{{MediaWiki:Wminc-manual-url}}|ספר ההוראות שלנו]].',
